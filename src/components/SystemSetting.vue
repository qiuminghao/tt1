...
<!--          <el-table-column type="data" label="日期" width="50" align="center"></el-table-column>-->
<!--          <el-table-column prop="allUserNumber" label="总用户数" width="180" sortable align="center"></el-table-column>-->
<!--          <el-table-column prop="appleUserNumber" label="苹果用户数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="androidUserNumber" label="安卓用户数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="newUser" label="新增用户" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="activeUserNumber" label="活跃用户数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="roomNumber" label="房间数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="friendRoomNumber" label="好友房间数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="clubRoomNumber" label="俱乐部房间数" width="180" align="center"></el-table-column>-->
<!--          <el-table-column prop="playRoomNumber" label="比赛房间数" width="180" align="center"></el-table-column>-->
        </el-table>
      </div>
    </el-card>
  </div>
