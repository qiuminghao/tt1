<template>
  <div class="scene-container">
    <el-card class="card1">
      <span>
          <h1 style="background:rgb(14,122,162)">比赛场</h1>
        <h4>查询总数：{{playground}} </h4>
      </span>
        ...
        <el-form-item label="搜索">
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>所有比赛场</el-dropdown-item>
              <el-dropdown-item>等待中的比赛</el-dropdown-item>
              <el-dropdown-item>以结束的比赛</el-dropdown-item>
              <el-dropdown-item>游戏中的比赛</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
          <el-dropdown>
            <el-button type="primary">
      ...
      <div class="table-section">
        <el-table :data="tableData"
          ...
          <el-table-column prop="statu" label="比赛场状态" width="180" sortable align="center"></el-table-column>
          <el-table-column prop="round" label="第几轮" width="180" align="center"></el-table-column>
